...
| GolfState | `src/caddai/golf_state/` | Player-neutral course-relative state (position, distance-to-hole-reference, lie/surface, terminal/holed) — see [ADR 0008](adr/0008-golf-state-domain-contract.md) |
